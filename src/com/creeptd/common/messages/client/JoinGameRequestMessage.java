...
public class JoinGameRequestMessage extends ClientMessage
    ...
    private static final String REGEXP_JOIN_GAME_REQUEST =
            "JOIN_GAME_REQUEST\\s([0-9]+)\\s\"([^\"]+)\"\\s(0|1)";
    /**
    ...
    public void initWithMessage(String messageString) {
        ...
        if (matcher.matches()) {
            ...
            this.setSpectate(matcher.group(3).equals("1"));
        }
    }
    ...
    public String getMessageString() {
        return "JOIN_GAME_REQUEST " + this.getGameId() + " " + "\"" + MessageUtil.prepareToSend(this.getPassword()) + "\" "+(this.spectate ? "1" : "0");
    }
}
