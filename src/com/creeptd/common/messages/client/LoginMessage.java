...
public class LoginMessage extends ClientMessage {
     ...
     */
    private static final String REGEXP_LOGIN_REQUEST = "LOGIN_REQUEST\\s\"([^\"]+)\"\\s\"([^\"]+)\"\\s\"([^\"]+)\"\\s\"([^\"]+)\"\\s\"([^\"]+)\"";
    /**
    ...
    public void initWithMessage(String messageString) {
        ...
        if (matcher.matches()) {
            ...
            this.setLanguage(matcher.group(5));
        }
    }
    ...
    public String getMessageString() {
        return "LOGIN_REQUEST \"" + MessageUtil.prepareToSend(this.getVersion()) + "\" \"" + MessageUtil.prepareToSend(this.getUsername()) + "\" \"" + MessageUtil.prepareToSend(this.getPassword()) + "\" \"" + MessageUtil.prepareToSend(this.getUid()) + "\" \""+MessageUtil.prepareToSend(this.getLanguage())+"\"";
    }
}
