...
public abstract class ClientMessage extends Message {
    ...
    public static ClientMessage renderMessageString(String messageString) {
        ...
        if (CreepEscapedMessage.PATTERN.matcher(messageString).matches()) {
        ...
        } else if (LoginMessage.PATTERN.matcher(messageString).matches()) {
        ...
        } else if (ChatMessage.PATTERN.matcher(messageString).matches()) {
