...
public class GamesMessage extends ServerMessage {
	private static final long serialVersionUID = 6985428262042734958L;

	//     private static final String REG_EXP =
//             "GAMES((\\sGAME\\s([0-9]+)\\s\"([^\"]+)\"\\s" + "([0-9]+)\\s([0-9]+)\\s([0-9]+)\\s([0-9]+)\\s([0-9]+)\\s([0-9]+)" + "\\s\"([^\"]*)\"\\s\"(.*)\"\\s\"(.*)\"\\s\"(.*)\"\\s\"(.*)\"\\s\"([^\"]+)\"\\s(0|1))\\s([0-9]+))*)";
    private static final String REG_EXP = "GAMES((\\sGAME "+GameDescription.REG_EXP+")*)";
