 ...
 * @author Daniel
 */
public class PlayerGameOverMessage extends ServerMessage implements GameMessage {
    
	private static final long serialVersionUID = -2594904325951570769L;
    ...
    public String getMessageString() {
        return "PLAYER_GAMEOVER "+this.roundId+" "+this.playerId+" "+(this.winner ? "1" : "0");
    }
