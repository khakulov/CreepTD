 ...
 *
 */
public class TransferCreepMessage extends ServerMessage implements GameMessage {

	private static final long serialVersionUID = -3238678181866655380L;
    ...
    public String getMessageString() {
        return "CREEP_TRANSFERED "+this.roundId+" "+this.playerId+" "+this.fromId+" "+this.creatorId+" "+this.creepId+" \""+this.creepType+"\" "+this.creepHealth+" "+this.transferCount;
    }
