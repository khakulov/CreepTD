...
/**
 * implementation of a Creep4.
 * @author sven
 *
 */
public class Creep4 extends AbstractCreep {
     ...
     */
    public Creep4(GameContext context, Constants.Creeps t) {
        super(context, t);
...
//		g2.dispose();
    ...
    public void loadImage() {
        ...
        if (Cache.getInstance().hasCreepImg(Constants.Creeps.creep4)) {
            setImage(Cache.getInstance().getCreepImg(Constants.Creeps.creep4));
        } else {

            try {
                BufferedImage forCache;
                this.image = ImageIO.read(this.getClass().getClassLoader().getResourceAsStream(
                        Constants.CREEPS_URL + "4.png"));
                forCache = this.image;
                Cache.getInstance().putCreepImg(Constants.Creeps.creep4, forCache);
