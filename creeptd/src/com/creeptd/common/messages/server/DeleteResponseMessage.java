 ...
 *
 */
public class DeleteResponseMessage extends ServerMessage {

    private static final String REG_EXP =
            "DELETE_RESPONSE\\s(ok|failed)";
    /**
    ...
    public String getMessageString() {
        return "DELETE_RESPONSE " + this.responseType.name();
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof DeleteResponseMessage)) {
            return false;
        }
        DeleteResponseMessage m = (DeleteResponseMessage) o;
