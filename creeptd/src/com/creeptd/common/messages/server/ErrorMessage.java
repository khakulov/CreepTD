...
public class ErrorMessage extends ServerMessage {
	...
	public String getMessageString() {
		return "ERROR " + this.errorType.name() + " " 
		+ MessageUtil.prepareToSend(this.errorMessage) + "";
	}
	...
	public boolean equals(Object o) {
		...
		return this.errorType == m.getErrorType()
			&& this.errorMessage.equals(m.getErrorMessage());
	}
