...
/**
 * Message from server to client. Response to UpdateDataRequestMessage.
 */
public class UpdateDataResponseMessage extends ServerMessage {

    private static final String REG_EXP =
            "UPDATE_DATA_RESPONSE\\s(ok|failed)";
    /**
    ...
    public String getMessageString() {
        return "UPDATE_DATA_RESPONSE " + this.responseType.name();
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof UpdateDataResponseMessage)) {
            return false;
        }
        UpdateDataResponseMessage m = (UpdateDataResponseMessage) o;
