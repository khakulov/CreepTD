 ...
 * 
 */
public class PlayerPositionMessageServer extends ServerMessage {
	 ...
	 * Default constructor.
	 */
	public PlayerPositionMessageServer() {
		super();
	}
	 ...
	 */
	public PlayerPositionMessageServer(Integer playerPosition1,
	...
	public String getMessageString() {
		return "PLAYER_POSIOTION " + this.playerPositionID1 + " "
				+ this.playerPositionID2 + " " + this.playerPositionID3 + " "
				+ this.playerPositionID4 + " " + this.player1 + " "
				+ this.player2 + " " + this.player3 + " " + this.player4;
	}
	...
	/**
	 * Returns true if o is a PlayerPositionMessage with the same contents as
	 * this one.
	 * 
	 * @param o
	...
	public boolean equals(Object o) {
		if (!(o instanceof PlayerPositionMessageServer)) {
			return false;
		}
		PlayerPositionMessageServer m = (PlayerPositionMessageServer) o;
		return this.getplayerPositionID1().equals(m.getplayerPositionID1())
				&& this.getplayerPositionID2().equals(m.getplayerPositionID2())
				&& this.getplayerPositionID3().equals(m.getplayerPositionID3())
				&& this.getplayerPositionID4().equals(m.getplayerPositionID4())
				&& this.getPlayer1().equals(m.getPlayer1())
				&& this.getPlayer2().equals(m.getPlayer2())
				&& this.getPlayer3().equals(m.getPlayer3())
				&& this.getPlayer4().equals(m.getPlayer4());

	}

	@Override
	public int hashCode() {
		return (int) 17 + 19 * this.getplayerPositionID1() + 23
				* this.getplayerPositionID2() + 29
				* this.getplayerPositionID3() + 31
				* this.getplayerPositionID4() + 37 * this.getPlayer1() + 41
				* this.getPlayer2() + 43 * this.getPlayer3() + 47
				* this.getPlayer4();
	}
