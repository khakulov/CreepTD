...
public class PlayerPositionMessageServer extends ServerMessage {
    ...
    public boolean equals(Object o) {
        ...
        return this.getplayerPositionID1().equals(m.getplayerPositionID1()) && this.getplayerPositionID2().equals(m.getplayerPositionID2()) && this.getplayerPositionID3().equals(m.getplayerPositionID3()) && this.getplayerPositionID4().equals(m.getplayerPositionID4()) && this.getPlayer1().equals(m.getPlayer1()) && this.getPlayer2().equals(m.getPlayer2()) && this.getPlayer3().equals(m.getPlayer3()) && this.getPlayer4().equals(m.getPlayer4());

    }

    @Override
    public int hashCode() {
        return (int) 17 + 19 * this.getplayerPositionID1() + 23 * this.getplayerPositionID2() + 29 * this.getplayerPositionID3() + 31 * this.getplayerPositionID4() + 37 * this.getPlayer1() + 41 * this.getPlayer2() + 43 * this.getPlayer3() + 47 * this.getPlayer4();
    }
}
