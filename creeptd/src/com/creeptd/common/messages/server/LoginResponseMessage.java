...
/**
 * Message from server to client. Contains response for 
 * LoginRequestMessage.
 * 
 * @author andreas
 *
...
public class LoginResponseMessage extends ServerMessage {
    ...
    private static final String REG_EXP = "LOGIN_RESPONSE\\s(failed|ok|version)";
    /**
    ...
    public String getMessageString() {
        return "LOGIN_RESPONSE " + this.responseType.name();
    }
    ...
    /**
     * Returns true if o is a LoginResponseMessage with the same
    ...
    public boolean equals(Object o) {
        if (!(o instanceof LoginResponseMessage)) {
            return false;
        }
        LoginResponseMessage m = (LoginResponseMessage) o;
