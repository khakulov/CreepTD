...
public class BuildTowerRoundMessage extends ServerMessage
    ...
    public boolean equals(Object o) {
        ...
        return this.roundId == m.getRoundId() && this.playerId == m.getPlayerId() && this.towerType.equals(m.getTowerType()) && this.towerPosition.equals(m.getTowerPosition()) && this.towerId == m.getTowerId();
    }
